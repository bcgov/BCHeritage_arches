...
details = {
    ...
    "name": "BC Primary Descriptors",
    "type": "primarydescriptors",
    "modulename": "bc_primary_descriptors.py",
    "description": "Function that provides the primary descriptors for BC Heritage resources",
    "defaultconfig": {
        "module": "arches_bchp.functions.bc_primary_descriptors",
        "class_name": "BCPrimaryDescriptors",
        "descriptor_types": {
            "name": {
                "type": "name",
                "node_ids": [],
    ...
    "classname": "BCPrimaryDescriptors",
    "component": "views/components/functions/bc-primary-descriptors",
}


class BCPrimaryDescriptors(AbstractPrimaryDescriptorsFunction):
