...
function($, _, arches, ko, koMapping, FunctionViewModel, chosen) {
    return ko.components.register('views/components/functions/bc-primary-descriptors', {
        ...
        template: {
            require: 'text!templates/views/components/functions/bc-primary-descriptors.htm'
        }
    });
});
