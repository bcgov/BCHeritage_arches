...
class Migration(migrations.Migration):
    dependencies = [('bcfms',
                     '0003_add_missing_featureids')]

    update_map_attribute_data_function = """
    ...
    revert_map_attribute_data_function ="""
        create or replace function get_map_attribute_data(p_resourceinstanceid uuid, nodeid uuid) returns jsonb as
            $$
        declare
            data jsonb;
    ...
    operations = [
        migrations.RunSQL(update_map_attribute_data_function, revert_map_attribute_data_function)
    ]
