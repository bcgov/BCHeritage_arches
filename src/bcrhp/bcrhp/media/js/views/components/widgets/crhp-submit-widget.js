define([
    ...
    'viewmodels/widget',
    'moment',
    'templates/views/components/widgets/crhp-submit-widget.htm',
    'bindings/datepicker',
    'bindings/moment-date',
    'bindings/chosen',
    'bindings/key-events-click',
], function(arches, ko, koMapping, _, WidgetViewModel, moment, datePickerWidgetTemplate) {
    /**
    ...
    var CrhpSubmitWidget = function(params) {
        var self = this;
        ...
        this.getCrhpXml = function() {
            ...
            {
                window.open(`${arches.urls.root}crhp_export/${self.tile.resourceinstance_id}`, '_blank');
            }
        }
    };

    return ko.components.register('crhp-submit-widget', {
