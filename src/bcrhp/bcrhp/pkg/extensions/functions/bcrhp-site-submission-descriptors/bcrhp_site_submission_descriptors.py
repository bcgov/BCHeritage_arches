...
class BCRHPSiteSubmissionDescriptors(BCPrimaryDescriptorsFunction):
    ...
    def __init__(self):
        ...
        self._graph_lookup = GraphLookup(BCRHPSiteSubmissionDescriptors._graph_slug,
                                         BCRHPSiteSubmissionDescriptors._name_nodes + BCRHPSiteSubmissionDescriptors._card_nodes)
