    ...
    create_databc_proxy_role = """
        ...
        $$
            ...
            BEGIN
                ...
                for databc_role in (select rolname from pg_roles where rolname = 'proxy_databc_dlvr') loop
                    Raise NOTICE 'Dropping role proxy_databc_dlvr and all associated grants';
                    drop owned by proxy_databc_dlvr cascade;
                    drop role proxy_databc_dlvr;
                end loop;
            END
        $$ language plpgsql;
    """
