...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists sos_ri_idx1;
        ...
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists pa_ri_idx1;
            drop index if exists pa_ri_idx2;
        ...
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists ld_ri_idx;
        ...
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists br_ri_idx;
        ...
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists gn_ri_idx;
        ...
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists pe_ri_fk_idx;
        ...
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists mv_pe_idx;
        ...
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists mv_sra_idx;
            drop index if exists mv_sra_idx2;
        ...
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists mv_hf_idx;
        ...
        RunPrivilegedSQL(
            ...
            """,
            """
            drop function if exists bc_get_utm_zone;
            """),
        RunPrivilegedSQL(
            """
            ...
            """,
            """
            drop function if exists bc_get_utm_srid;
            """),
        RunPrivilegedSQL(
            """
            ...
            """,
            """
            drop function if exists bc_get_utm_northing;
            """),
        RunPrivilegedSQL(
            """
            ...
            """,
            """
            drop function if exists bc_get_utm_easting;
            """),
        RunPrivilegedSQL(
            """
            begin;
            drop index if exists mv_sb_idx;
