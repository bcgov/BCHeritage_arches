...
def forward(apps, schema_editor):
    call_command('packages', operation='delete_mapbox_layer', layer_name='Natural Resource Regions')
    ...
    call_command('packages', operation='delete_mapbox_layer', layer_name='Provinces and States')
    call_command('packages', operation='delete_mapbox_layer', layer_name='TRIM Contours')
