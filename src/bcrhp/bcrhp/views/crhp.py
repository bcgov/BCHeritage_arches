    ...
    def get_context_data(self, resourceinstanceid):
        ...
        try:
            ...
            for item in context["data"].protection_events:
                logger.info("\tAuthority: %s:%s (%s)" % (item["authority"], item["designation_or_protection_start_date"], type(item["designation_or_protection_start_date"])))
            ...
            for item in context["data"].protection_events:
                logger.info("\tAuthority: %s:%s" % (item["authority"], item["designation_or_protection_start_date"]))
